import TalentLoginPage from "@/features/public/auth/login_talent";
...
import VacancyDetail from "@/features/talent/recruitment/detail_vacancy";
import { Route } from "react-router-dom";

export default function TalentRoutes() {
    return (
        <>
            {/* Layout utama recruitment */}
            <Route path="/recruitment" element={<RecruitmentLayout />} />

            {/* Auth */}
            <Route path="/recruitment/register" element={<TalentRegisterPage />} />
            <Route path="/login" element={<TalentLoginPage />} />

            {/* Vacancies List */}
            <Route path="/recruitment/vacancies" element={<AllVacancies />} />

            {/* Vacancy Detail (dynamic id) */}
            <Route path="/recruitment/vacancies/:id" element={<VacancyDetail />} />
