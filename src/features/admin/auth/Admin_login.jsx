...
export default function AdminLoginPage() {
    ...
    return (
        <div className="min-h-screen flex relative overflow-hidden">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-purple-500 via-blue-500 to-blue-700 items-center justify-center p-12">
                <div
            ...
            <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-6 relative">
                ...
                {/* Top Right */}
                <div className="absolute top-10 right-20 w-16 h-16 bg-blue-100 rounded-full opacity-40" />
                <div className="absolute top-32 right-40 w-8 h-8 bg-purple-200 rounded-full opacity-50" />
                <div className="absolute top-1/4 right-12 w-12 h-12 border-2 border-blue-200 rotate-45" />

                {/* Bottom Left */}
                <div className="absolute bottom-20 left-32 w-20 h-20 bg-gradient-to-br from-blue-100 to-purple-100 rounded-full opacity-30" />
                <div className="absolute bottom-40 left-16 w-10 h-10 border-2 border-purple-300 rounded-full opacity-40" />

                {/* Bottom Right */}
                <div className="absolute bottom-20 right-32 w-20 h-20 bg-gradient-to-br from-blue-100 to-purple-100 rounded-full opacity-30" />
                <div className="absolute bottom-40 right-16 w-10 h-10 border-2 border-purple-300 rounded-full opacity-40" />

                {/* Center */}
                <div className="absolute top-1/2 right-8 w-6 h-6 bg-blue-300 rotate-45 opacity-40" />
                ...
                />
                <div
                    className="absolute top-2/3 left-60 w-14 h-14 bg-blue-100 opacity-30"
                ...
                <div className="absolute top-24 right-32 w-2 h-2 bg-blue-400 rounded-full" />
                ...
                <div className="absolute bottom-32 right-52 w-3 h-3 bg-blue-400 rounded-full" />
