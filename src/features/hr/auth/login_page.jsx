...
export default function HrLoginPage() {
    ...
    return (
        <div className="min-h-screen flex relative overflow-hidden">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-pink-400 via-orange-400 to-orange-500 items-center justify-center p-12">
                <div
            ...
            <div className="w-full lg:w-1/2 bg-white flex items-center justify-center p-6 relative">
                ...
                {/* Top Right */}
                <div className="absolute top-10 right-20 w-16 h-16 bg-orange-100 rounded-full opacity-40" />
                <div className="absolute top-32 right-40 w-8 h-8 bg-purple-200 rounded-full opacity-50" />
                <div className="absolute top-1/4 right-12 w-12 h-12 border-2 border-orange-200 rotate-45" />

                {/* Bottom Left */}
                <div className="absolute bottom-20 left-32 w-20 h-20 bg-gradient-to-br from-orange-100 to-purple-100 rounded-full opacity-30" />
                <div className="absolute bottom-40 left-16 w-10 h-10 border-2 border-purple-300 rounded-full opacity-40" />

                {/* Bottom Right */}
                <div className="absolute bottom-20 right-32 w-20 h-20 bg-gradient-to-br from-orange-100 to-purple-100 rounded-full opacity-30" />
                <div className="absolute bottom-40 right-16 w-10 h-10 border-2 border-purple-300 rounded-full opacity-40" />

                {/* Center */}
                <div className="absolute top-1/2 right-8 w-6 h-6 bg-orange-300 rotate-45 opacity-40" />
                ...
                />
                <div
                    className="absolute top-2/3 left-60 w-14 h-14 bg-orange-100 opacity-30"
                ...
                <div className="absolute top-24 right-32 w-2 h-2 bg-orange-400 rounded-full" />
                ...
                <div className="absolute bottom-32 right-52 w-3 h-3 bg-orange-400 rounded-full" />
                ...
                <CardContent className="p-8">
                    <div className="mb-8">
                    <h1 className="text-3xl font-bold text-orange-400 text-center mb-2">
                        Login
                    </h1>
                    </div>
                    ...
                    <Button
                        onClick={handleLogin}
                        className="w-full h-12 bg-orange-400 hover:bg-orange-500 text-white font-semibold text-base rounded-md shadow-md transition-all duration-300"
                    >
                        Log in!
                    </Button>
                    </div>
            ...
            <div className="lg:hidden absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full px-6">
                ...
                <CardContent className="p-8">
                    ...
                    <Button
                        onClick={handleLogin}
                        className="w-full h-12 bg-orange-500 hover:bg-orange-600 text-white font-semibold text-base rounded-md shadow-md transition-all duration-300"
                    >
                        Log in!
                    </Button>
                    </div>
