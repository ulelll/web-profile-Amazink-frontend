...
const Button = ({ variant = "default", size = "default", className = "", children, ...props }) => {
    ...
    const variantClasses = {
        ...
        outline: "border-2 border-blue-600 bg-white text-blue-600 hover:bg-blue-50 hover:border-blue-700",
                ...
                <div className="flex items-center gap-3 relative" ref={dropdownRef}>
                    {!user ? (
                        <>
                            ...
                            <Button variant="default" onClick={() => navigate("/recruitment/register")}>
                                Register
                            </Button>
                        </>
                    ) : (
