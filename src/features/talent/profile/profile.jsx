...
import { Button, Card, CardContent, CardHeader, CardTitle, Input, Label, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Switch, Textarea } from '@/components/ui';
                ...
                <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="mb-8 flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-3">
                            <Label htmlFor="edit-mode" className="text-sm font-medium">Mode Edit</Label>
                            <Switch
                                id="edit-mode"
                                checked={!isDisable}
                                onCheckedChange={() => setDisable(!isDisable)}
                            />
                        </div>
                    </div>
